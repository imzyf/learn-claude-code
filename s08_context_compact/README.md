...
1. `Read s01_agent_loop/upstream.README.zh.md and give me its top-level headings.`
   读 s01_agent_loop/upstream.README.zh.md，给我它的一级标题。
2. `Now do the same for s02_tool_use/upstream.README.zh.md.`
   对 s02_tool_use/upstream.README.zh.md 做同样的事。
3. `Same for s03_permission/upstream.README.zh.md.`
   s03_permission/upstream.README.zh.md 也一样。
